                ...
                <div class="container-fluid">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Upload Photo <span><?php Message::DisplayMessage() ?></h3>
                        </div>
                        <form id="photoForm" action="../formProcess/update.photo.process.php" method="POST" enctype="multipart/form-data">
                            <div class="card-body">
                                <div class="form-group">
                                    <img id="photoPreview" src="" alt="Selected Photo" style="display: none; width: 150px; height: 200px; margin-bottom: 15px;">
                                </div>
                                <div class="form-group">
                                    <label for="photoInput">Select Photo</label>
                                    <input type="file" class="form-control" id="photoInput" name="Profile_Image" accept="image/*">
                                </div>
                            </div>
