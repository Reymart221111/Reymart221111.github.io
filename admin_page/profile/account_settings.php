...
$row = FetchDisplayData::FetchUserProfile();
                        ...
                        <div class="col-md-12">
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Account Information <span><?php Message::DisplayMessage() ?></h3>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <form id="addRecipeForm" action="../formProcess/update.account.process.php" method="POST">
                                        <div class="form-group">
                                            <label for="recipeName">Name:</label>
                                            <input type="text" class="form-control" id="name" name="name" value="<?php echo $row['UserName'] ?>" placeholder="Enter User Name" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="recipeName">Email:</label>
