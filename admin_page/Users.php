                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    <h3 class="card-title">Recipes <span><?php Message::DisplayMessage() ?></span></h3>
                                    <a href="USerAction/AddUser.php" class="btn btn-success btn-sm ml-auto" style="font-size: 18px;">
                                        +<span style="font-size: 14px;"> Add User</span>
                                    </a>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                        ...
                                        <tbody>
                                            ...
                                            if ($result->num_rows > 0) {
                                                while ($row = $result->fetch_assoc()) {
                                                    ...
                                                    echo "<td><img src='" . ($row['Profile_path'] ? $row['Profile_path'] : '/Recipe_Sharing_Web/ImgUploads/user_PROFILE/no-IMG.jpg') . "' width='100' height='120'></td>";
                                                    echo "<td>" . $row['UserName'] . "</td>";
                                                    echo "<td>" . $row['Email'] . "</td>";
                                                    echo "<td>" . $row['Role'] . "</td>";
                                                    echo "<td>" . $row['RegisteredDate'] . "</td>";
                                                    echo "<td>";
                                                    echo '<a href="UserAction/EditUser.php?id=' . urlencode($row['UserID']) . '" class="btn btn-primary btn-sm">Update</a> ';
                                                    echo '<a href="formProcess/delete.user.process.php?id=' . urlencode($row['UserID']) . '" class="btn btn-danger btn-sm" onclick="return confirm(\'Are you sure you want to delete this record?\')">Delete</a>';
                                                    echo "</td>";
                                                    echo "</tr>";
                                                }
                                            } else {
