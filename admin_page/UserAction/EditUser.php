...
$row = FetchDisplayData::DisplayUserSelectedData();
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Add User <span><?php Message::DisplayMessage() ?></h3>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <form id="addRecipeForm" action="../formProcess/edit.user.process.php?id=<?php echo $row['UserID'] ?>" method="POST">
