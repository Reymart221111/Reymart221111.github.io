                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="nationality.php" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Cuisine Nationality</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="meal_type.php" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Meal Type</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="restrictions.php" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                        ...
                        <li class="nav-item">
                            <a href="../recipe.page.php" class="nav-link">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    <h3 class="card-title">Recipe Categories <span><?php Message::DisplayMessage() ?></h3>
                                    <a href="adding_action_modal/adding_nationality.php" id="AddModal" class="btn btn-success btn-sm ml-auto" style="font-size: 18px;">
                                ...
                                <div class="card-body">
                                    <table id="recipeCategories" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            $stmt = $conn->prepare("SELECT * FROM cuisinenationality");
                                            $stmt->execute();
                                            ...
                                            if ($result->num_rows > 0) {
                                                while ($row = $result->fetch_assoc()) {
                                                    echo "<tr>";
                                                    echo "<td>" . htmlspecialchars($row['CuisineID']) . "</td>";
                                                    echo "<td>" . htmlspecialchars($row['CuisineOrigin']) . "</td>";
                                                    echo "<td>";
                                                    echo '<a href="edit_action_modal/editting_nationality.php?id=' . urlencode($row['CuisineID']) . '" class="btn btn-primary btn-sm">Update</a> ';
                                                    echo '<a href="../formProcess/delete.nationality.process.php?id=' . urlencode($row['CuisineID']) . '" class="btn btn-danger btn-sm" onclick="return confirm(\'Are you sure you want to delete this record?\')">Delete</a>';
                                                    echo "</td>";
                                                    echo "</tr>";
                                                }
                                            } else {
