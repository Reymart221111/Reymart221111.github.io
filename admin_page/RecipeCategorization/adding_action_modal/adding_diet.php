                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <form id="addMealForm" action="../../formProcess/add.diet.restriction.process.php" method="post">
                                        <div class="form-group">
                                            <label for="nationality">Restriction Type:</label>
                                            <input type="text" class="form-control" id="diet_restriction" name="diet_restriction" placeholder="Enter Restriction Type" required>
                                        </div>
