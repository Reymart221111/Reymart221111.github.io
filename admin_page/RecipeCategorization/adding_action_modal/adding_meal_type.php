                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Meal Type <span><?php Message::DisplayMessage() ?></h3>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <form id="addMealForm" action="../../formProcess/add.meal.type.process.php" method="POST">
                                        <div class="form-group">
                                            <label for="nationality">Meal Type:</label>
