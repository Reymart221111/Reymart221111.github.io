                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <form id="addNationalityForm" action="../../formProcess/add.nationality.process.php" method="POST">
                                        <div class="form-group">
                                            <label for="nationality">Cuisine Origin:</label>
                                            <input type="text" class="form-control" id="nationality" name="nationality" placeholder="Enter Cuisine Origin" required>
                                        </div>
