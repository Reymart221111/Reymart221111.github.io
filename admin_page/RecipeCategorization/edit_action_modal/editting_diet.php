...
$row = FetchDisplayData::DisplayRestrictionData();
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Restriction Type <span><?php Message::DisplayMessage() ?></h3>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <form id="addMealForm" action="../../formProcess/edit.diet.restriction.process.php?id=<?php echo $row['RestrictionID'] ?>" method="post">
                                        <div class="form-group">
                                            <label for="nationality">Restriction Type:</label>
                                            <input type="text" class="form-control" id="diet_restriction" name="diet_restriction" value="<?php echo $row['Restriction'] ?>" placeholder="Enter Restriction Type" required>
                                        </div>
