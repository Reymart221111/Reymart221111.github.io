...
$row = FetchDisplayData::DisplayMealTypeSelectedData();
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <form id="addMealForm" action="../../formProcess/edit.meal.type.process.php?id=<?php echo $row['MealTypeID'] ?>" method="POST">
                                        <div class="form-group">
                                            <label for="nationality">Meal Type:</label>
                                            <input type="text" class="form-control" id="meal_type" name="meal_type" value="<?php echo $row['MealType'] ?>" placeholder="Enter Meal Type" required>
                                        </div>
