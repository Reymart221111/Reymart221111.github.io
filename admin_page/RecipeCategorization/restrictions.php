                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    ...
                                    <a href="adding_action_modal/adding_diet.php" class="btn btn-success btn-sm ml-auto" style="font-size: 18px;">
                                ...
                                <div class="card-body">
                                    <table id="recipeCategories" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            $stmt = $conn->prepare("SELECT * FROM dietrestriction");
                                            $stmt->execute();
                                            ...
                                            if ($result->num_rows > 0) {
                                                while ($row = $result->fetch_assoc()) {
                                                    echo "<tr>";
                                                    echo "<td>" . htmlspecialchars($row['RestrictionID']) . "</td>";
                                                    echo "<td>" . htmlspecialchars($row['Restriction']) . "</td>";
                                                    echo "<td>";
                                                    echo '<a href="edit_action_modal/editting_diet.php?id=' . urlencode($row['RestrictionID']) . '" class="btn btn-primary btn-sm">Update</a> ';
                                                    echo '<a href="../formProcess/delete.diet.restriction.process.php?id=' . urlencode($row['RestrictionID']) . '" class="btn btn-danger btn-sm" onclick="return confirm(\'Are you sure you want to delete this record?\')">Delete</a>';
                                                    echo "</td>";
                                                    echo "</tr>";
                                                }
                                            } else {
