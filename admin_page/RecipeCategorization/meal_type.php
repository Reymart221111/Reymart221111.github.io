                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="meal_type.php" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Meal Type</p>
                                    </a>
                                </li>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Recipe Categorization</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    ...
                                    <a href="adding_action_modal/adding_meal_type.php" id="AddModal" class="btn btn-success btn-sm ml-auto" style="font-size: 18px;">
                                ...
                                <div class="card-body">
                                    <table id="recipeCategories" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            $stmt = $conn->prepare("SELECT * FROM MealType");
                                            $stmt->execute();
                                            ...
                                            if ($result->num_rows > 0) {
                                                while ($row = $result->fetch_assoc()) {
                                                    echo "<tr>";
                                                    echo "<td>" . htmlspecialchars($row['MealTypeID']) . "</td>";
                                                    echo "<td>" . htmlspecialchars($row['MealType']) . "</td>";
                                                    echo "<td>";
                                                    echo '<a href="edit_action_modal/editting_meal_type.php?id=' . urlencode($row['MealTypeID']) . '" class="btn btn-primary btn-sm">Update</a> ';
                                                    echo '<a href="../formProcess/delete.meal.type.process.php?id=' . urlencode($row['MealTypeID']) . '" class="btn btn-danger btn-sm" onclick="return confirm(\'Are you sure you want to delete this record?\')">Delete</a>';
                                                    echo "</td>";
                                                    echo "</tr>";
                                                }
                                            } else {
