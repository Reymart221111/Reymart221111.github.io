...
$row = FetchDisplayData::DisplayRecipeData();
            ...
            <ul class="navbar-nav ml-auto">
               ...
               <span><?php echo $userData['UserName'] ?></span>
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        ...
                        <a href="/Recipe_Sharing_Web/admin_page/profile/update_photo.php" class="dropdown-item">
                            <i class="fas fa-user-circle mr-2"></i> Update Photo
                        </a>
                        <a href="/Recipe_Sharing_Web/admin_page/profile/account_settings.php" class="dropdown-item">
                            <i class="fas fa-cog mr-2"></i> Account Settings
                        </a>
                        <a href="/Recipe_Sharing_Web/admin_page/profile/change_password.php" class="dropdown-item">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <form id="addRecipeForm" action="../formProcess/edit.recipe.process.php?id=<?php echo $row['RecipeID'] ?>" method="post" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label for="recipeName">Recipe Name:</label>
                                            <input type="text" class="form-control" id="recipeName" name="recipe_name" value="<?php echo $row['RecipeName'] ?>" placeholder="Enter Recipe Name" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="ingredients">Ingredients:</label>
                                            <textarea class="form-control" id="ingredients" name="ingredients" rows="6" placeholder="List ingredients" required><?php echo $row['Ingredients'] ?></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label for="procedure">Cooking Procedure:</label>
                                            <textarea class="form-control" id="procedure" name="procedure" rows="8" placeholder="Describe the cooking procedure" required><?php echo $row['Procedures'] ?></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label for="nationality">Nationality Origin</label>
                                            <select class="form-control" id="nationality" name="nationality">
                                                <option value="">None</option>
                                                <?php FetchDisplayData::DisplayNationalitySelectedOption() ?>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="meal_type" name="meal_type">
                                                <option value="">None</option>
                                                <?php FetchDisplayData::DisplayMealTypeSelectedOption() ?>
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="restriction" name="restriction">
                                                <option value="">None</option>
                                                <?php FetchDisplayData::DisplayRestrictionSelectedOption() ?>
                                            </select>
                                        </div>
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                <label for="cookingTime">Cooking Time:</label>
                                                <input type="number" class="form-control" id="cookingTime" name="cooking_time" value="<?php echo $row['CookingTime'] ?>" placeholder="Enter Cooking Time (e.g., 45 minutes)" required>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label for="servingSize">Serving Size:</label>
                                                <input type="number" class="form-control" id="servingSize" name="serving_size" value="<?php echo $row['ServingSize'] ?>" placeholder="Enter Serving Size (e.g., 4)" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <img id="photoPreview" src="<?php echo $row['ImagePath'] ?>" alt="Selected Photo" style="display: width: 300px; height: 400px; margin-bottom: 15px;">
                                        </div>
                                        <div class="form-group">
                                            <label for="recipeImage">Update Image:</label>
                                            <input type="file" class="form-control-file" id="recipeImage" name="recipe_image" accept="image/*">
                                        </div>
