                    ...
                    <div class="row">
                        <div class="col-lg-3 col-6">
                            ...
                            <div class="small-box bg-info">
                                <div class="inner">
                                    <h3><?php echo FetchDisplayData::FetchRecipeCount() ?></h3>
                                ...
                                <a href="recipe.page.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                        <!-- ./col -->
                        <div class="col-lg-3 col-6">
                            ...
                            <div class="small-box bg-success">
                                <div class="inner">
                                    <h3><?php echo FetchDisplayData::FetchRecipeCategoryCount() ?></h3>
                        ...
                        <div class="col-lg-3 col-6">
                            ...
                            <div class="small-box bg-warning">
                                <div class="inner">
                                    <h3><?php echo FetchDisplayData::FetchUserChefCount() ?></h3>
                                    <p>Chefs</p>
                                </div>
                                <div class="icon">
                        ...
                        <div class="col-lg-3 col-6">
                            ...
                            <div class="small-box bg-danger">
                                <div class="inner">
                                    <h3><?php echo FetchDisplayData::FetchUserAdminCount() ?></h3>
                                    <p>Admins</p>
                                </div>
                                <div class="icon">
